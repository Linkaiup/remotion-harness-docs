...
- **Harness 工程：** Agent 驱动 Remotion 需要 5 层工程化设施（代码生成管线 + 组件库 + 质量保障 + 性能优化 + 错误恢复），共 15 个 MVP 必须模块，预估开发周期 6-8 周。
...
| 渲染速度 | 单机 1-3 fps / Lambda 并行 | ~41 秒/5 秒视频 | ~41 秒/5 秒视频 |
...
**版本现状（2026 年 7 月）：** Remotion 4.0.x 系列，GitHub 28K+ stars，每周有 PR 合入，迭代活跃。
